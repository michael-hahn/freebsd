...
struct sysent sysent[] = {
	...
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 561 = placeholder */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 562 = placeholder */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 563 = placeholder */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 564 = placeholder */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 565 = placeholder */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 566 = placeholder */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 567 = placeholder */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 568 = placeholder */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 569 = placeholder */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 570 = placeholder */
	{ AS(metaio_read_args), (sy_call_t *)sys_metaio_read, AUE_READ, NULL, 0, 0, 0, SY_THR_STATIC },	/* 571 = metaio_read */
	{ AS(metaio_write_args), (sy_call_t *)sys_metaio_write, AUE_WRITE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 572 = metaio_write */
	{ AS(metaio_mmap_args), (sy_call_t *)sys_metaio_mmap, AUE_MMAP, NULL, 0, 0, 0, SY_THR_STATIC },	/* 573 = metaio_mmap */
